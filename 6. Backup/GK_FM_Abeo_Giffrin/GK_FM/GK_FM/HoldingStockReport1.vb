...
Public Class HoldingStockReport1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "HoldingStockReport1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GK_FM.HoldingStockReport1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHoldingStockReport1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HoldingStockReport1 = New HoldingStockReport1()
        rpt.Site = Me.Site
        Return rpt
    End Function

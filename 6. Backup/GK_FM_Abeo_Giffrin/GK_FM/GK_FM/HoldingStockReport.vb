...
Public Class HoldingStockReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GK_FM.HoldingStockReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHoldingStockReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HoldingStockReport = New HoldingStockReport()
        rpt.Site = Me.Site
        Return rpt
    End Function

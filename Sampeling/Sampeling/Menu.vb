...
Namespace Sampeling
    Public Class Menu
        ...
        Sub AddMenuItems()
            ...
            oCreationPackage.UniqueID = "Sampeling"
            oCreationPackage.String = "Sampeling"
            ...
            Try
                ...
                oMenuItem = Application.SBO_Application.Menus.Item("Sampeling")
                oMenus = oMenuItem.SubMenus
                ...
                'oCreationPackage.UniqueID = "Sampeling.Form1"
        ...
        Sub SBO_Application_MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean) Handles SBO_Application.MenuEvent
            ...
            Try
                If (pVal.BeforeAction And pVal.MenuUID = "Sampeling.Form1") Then
